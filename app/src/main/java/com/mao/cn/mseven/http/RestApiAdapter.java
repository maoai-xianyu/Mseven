...
// | Description:
// +----------------------------------------------------------------------
package com.mao.cn.mseven.http;

import com.google.gson.Gson;
import com.mao.cn.mseven.MsevenApplication;
import com.mao.cn.mseven.factory.StringConverterFactory;
...
public class RestApiAdapter {
    ...
    public static Retrofit getStringInstance() {
        ...
        if (sharedStringInstance == null) {
            sharedStringInstance = new Builder()
                    .baseUrl(MsevenApplication.serverInfo().getServerHost())
                    .client(client)
                    .addConverterFactory(new StringConverterFactory())
                    .addConverterFactory(GsonConverterFactory.create(new Gson()))
                    .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
    ...
    public static Retrofit getRxGsonInstance() {
        ...
        if (rxGsonInstance == null) {
            rxGsonInstance = new Builder().baseUrl(MsevenApplication.serverInfo().getServerHost())
                    .client(client)
                    .addConverterFactory(new StringConverterFactory())
