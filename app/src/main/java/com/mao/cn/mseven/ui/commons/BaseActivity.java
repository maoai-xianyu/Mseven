...
import com.mao.cn.mseven.common.CommActivity;
...
import com.mao.cn.mseven.wedget.animation.animationeffects.Effectstype;
import com.mao.cn.mseven.wedget.dialog.DefineTwoBottomDialog;
import com.mao.cn.mseven.wedget.dialog.LoadingDialog;
import com.mao.cn.mseven.wedget.dialog.SingleDialog;
...
public abstract class BaseActivity extends CommActivity implements BaseViewInferface {
    ...
    public void setting() {
        ...
        MsevenApplication.addAty(activity);
    ...
    protected void onDestroy() {
        ...
        MsevenApplication.removeAty(activity);
        super.onDestroy();
    }
