...
import com.mao.cn.mseven.utils.network.MyOKHttpFactoryU;
import com.mao.cn.mseven.utils.network.NetworkUtils;
import com.mao.cn.mseven.utils.network.OKHttpClientFactory;
...
public class OkhttpShowContentPresenterImp extends BasePresenterImp implements OkhttpShowContentPresenter {
    ...
    public void getMovieTopMyOkHttp(int start, int count) {
        ...
        clientFactory.okHttpGetMovieTop(MsevenApplication.serverInfo().getServerHost() + "v2/movie/top250", params, new IResponseHandler() {
            @Override
